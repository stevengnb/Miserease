    ...
    <button
      className={
        isFixed
          ...
          : isDetail
          ? " top-5 left-5 w-11 h-11 rounded-full bg-accent text-neutral hover:bg-neutral hover:text-accent flex items-center justify-center transition-all duration-300 shadow-xl"
